...
class ReclamosControllerTest < ActionController::TestCase
  ...
  test "should create reclamo" do
    assert_difference('Reclamo.count') do
      post :create, reclamo: { nombre_empresa: @reclamo.nombre_empresa, reclamo: @reclamo.reclamo, user_id: @reclamo.user_id }
    end
  ...
  test "should update reclamo" do
    patch :update, id: @reclamo, reclamo: { nombre_empresa: @reclamo.nombre_empresa, reclamo: @reclamo.reclamo, user_id: @reclamo.user_id }
    assert_redirected_to reclamo_path(assigns(:reclamo))
  end
